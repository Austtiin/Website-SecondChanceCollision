...
export const metadata: Metadata = {
  title: {
    absolute: "Second Chance Collision | Auto Body Repair, Circle Pines MN",
  },
  description:
    "Insurance-approved collision repair, bumper repair, dent removal & paint services in Circle Pines, Blaine, Lino Lakes & the North Metro. Free estimates.",
  keywords: [
    // "Near Me" searches
...
export default function Home() {
  ...
  return (
    <div className="space-y-12">
      {/* Modern Hero Section */}
      <section className="relative overflow-hidden rounded-2xl shadow-xl min-h-[min(720px,calc(100dvh-8rem))] flex flex-col">
        {/* Background Image with Overlay */}
        <div className="absolute inset-0">
          <Image
            src="/Gallery/IMG_20260222_165739.webp"
          ...
          <div className="absolute inset-0 bg-linear-to-br from-[#12171b]/75 via-[#12171b]/65 to-[#0a0d10]/75" />
          <div className="absolute inset-0 bg-linear-to-t from-[#12171b]/80 via-transparent to-transparent" />
        </div>
        
        <div className="relative flex-1 flex items-center justify-center py-4 sm:py-6 px-4 sm:px-8 lg:px-12">
          <div className="max-w-4xl mx-auto text-center space-y-2 sm:space-y-3 w-full">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 rounded-full bg-(--accent-red)/20 px-4 py-1.5 ring-1 ring-(--accent-red)/30">
            ...
            <div className="space-y-2 sm:space-y-3">
              <h1 className="text-2xl font-bold leading-tight tracking-tight text-white sm:text-3xl lg:text-4xl">
                Auto Body & Collision Repair in Circle Pines, MN
              </h1>
              <p className="hidden sm:block text-sm sm:text-base lg:text-lg leading-relaxed text-neutral-300 max-w-2xl mx-auto">
                Collision repair, bumper repair, and paint services for the North Metro. Certified technicians, insurance-approved.
              </p>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full bg-accent-red px-5 py-2.5 sm:px-6 sm:py-3 text-sm sm:text-sm font-bold text-white shadow-md transition hover:bg-red-700 cursor-pointer"
              >
              ...
              <EmailLink
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-white bg-white px-5 py-2.5 sm:px-6 sm:py-3 text-sm sm:text-sm font-bold text-[#12171b] shadow-md transition hover:bg-neutral-100 cursor-pointer"
              >
                <svg className="h-5 w-5 sm:h-4 sm:w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {/* Quick Info Row */}
            <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 pt-3 sm:pt-4 max-w-3xl mx-auto">
              ...
              <div className="flex items-center gap-2">
                ...
                <Link href="/insurance-claims" className="text-xs sm:text-sm font-semibold text-white hover:text-red-300">
      ...
      <section id="services-section" className="relative space-y-8 scroll-mt-20">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {/* Collision Repair */}
          <div className="rounded-2xl bg-linear-to-br from-red-50 to-white p-6 shadow-md ring-1 ring-red-100 transition hover:shadow-lg">
            <div className="space-y-4">
              <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-linear-to-br from-accent-red to-red-600 shadow-md">
          ...
          {/* Paint & Refinishing */}
          <div className="rounded-2xl bg-linear-to-br from-white to-neutral-50 p-6 shadow-md ring-1 ring-black/5 transition hover:shadow-lg">
            <div className="space-y-4">
              <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-linear-to-br from-accent-red to-red-600 shadow-md">
                <svg className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="rounded-2xl bg-linear-to-br from-white to-neutral-50 p-6 shadow-md ring-1 ring-black/5 transition hover:shadow-lg">
            <div className="space-y-4">
              <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-linear-to-br from-accent-dark to-[#1f252c] shadow-md">
                <svg className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <section id="insurance-section" className="rounded-2xl bg-neutral-900 p-8 shadow-lg scroll-mt-20">
        <div className="text-center space-y-6 max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            ...
            <p className="text-base text-neutral-300 leading-relaxed">
              Filing a claim? We coordinate with all major insurance carriers, handle adjuster communication, and bill your insurer directly for the approved repair amount - so in most cases you only pay your deductible.
            </p>
          </div>
      ...
      <ScrollReveal delay={100}>
      <section className="rounded-2xl bg-linear-to-br from-white via-red-50/20 to-neutral-50 p-6 shadow-md ring-1 ring-red-100/50 md:flex md:items-center md:gap-8 md:p-8">
        <div className="relative mb-4 h-56 w-full overflow-hidden rounded-2xl bg-neutral-900 md:mb-0 md:h-64 md:flex-1">
          <Image
            src="/Gallery/1000134899.webp"
      ...
      {/* Estimate / CTA */}
      <ScrollReveal delay={150}>
      <section id="estimate-section" className="rounded-2xl bg-linear-to-br from-[#12171b] to-[#0f1419] p-6 text-sm text-neutral-100 shadow-lg md:flex md:items-center md:justify-between md:gap-6 md:p-7 scroll-mt-20">
        <div className="space-y-2">
        ...
        <div className="mt-4 flex flex-wrap gap-3 md:mt-0 md:justify-end">
          <a
            href="tel:612-913-6594"
            className="inline-flex items-center justify-center gap-2 rounded-full bg-accent-red px-5 py-2.5 text-xs font-bold text-white shadow-md transition hover:bg-red-700 cursor-pointer"
          >
