      ...
      <div className="relative max-w-md w-full rounded-2xl bg-white p-8 shadow-2xl ring-1 ring-black/10 animate-in zoom-in-95 duration-200">
        <div className="space-y-6 text-center">
          ...
          <div className="space-y-2">
            <h3 className="text-2xl font-bold text-accent-dark">Thank You!</h3>
            <p className="text-base text-neutral-600 leading-relaxed">
              You will be redirected to your mail application shortly
            </p>
            <div className="flex items-center justify-center gap-2 text-accent-red font-bold text-lg">
          ...
          <button
            onClick={onClose}
            className="mt-4 w-full rounded-full bg-accent-red px-6 py-3 text-base font-bold text-white shadow-lg transition hover:bg-red-700 hover:scale-105 cursor-pointer"
