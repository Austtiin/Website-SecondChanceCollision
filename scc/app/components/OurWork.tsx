    ...
    return (
      <section className="relative space-y-8">
        <div className="text-center space-y-3">
          ...
          <h2 className="text-3xl font-bold text-accent-dark sm:text-4xl">Our Work</h2>
          <p className="text-neutral-600 max-w-2xl mx-auto">
            Our project gallery is coming soon. Check back to see examples of our quality workmanship.
          </p>
        </div>
        <div className="relative overflow-hidden rounded-2xl bg-linear-to-br from-neutral-50 to-white p-12 text-center shadow-lg ring-1 ring-black/5">
          <div className="pointer-events-none absolute -right-8 -top-8 h-32 w-32 rounded-full bg-(--accent-red)/10 blur-3xl" />
        ...
        >
          ...
          <div className="p-4 sm:p-8">
            <div className="mb-6 flex items-center justify-between">
              <div>
                <h3 className="text-2xl sm:text-3xl font-bold text-accent-dark">{selectedProject.name}</h3>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {selectedProject.files.map((file, fileIndex) => {
                ...
                return (
                  <div 
                    key={fileIndex} 
                    className={`relative rounded-xl bg-neutral-900 shadow-lg aspect-video overflow-hidden ${!isVideo ? 'cursor-pointer hover:ring-4 hover:ring-(--accent-red)/50 transition' : ''}`}
            ...
            <div className="mt-8 pt-6 pb-4 border-t border-neutral-200">
              <div className="text-center space-y-4">
                <div className="space-y-2">
                  <h4 className="text-lg sm:text-xl font-bold text-accent-dark">Looking for Similar Quality Work?</h4>
                ...
                <div className="flex flex-wrap items-center justify-center gap-3">
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-full bg-accent-red px-6 py-3 text-sm font-bold text-white shadow-lg transition hover:bg-red-700 hover:scale-105 cursor-pointer"
                  >
                  ...
                  <EmailLink
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-accent-red bg-white px-6 py-3 text-sm font-bold text-accent-red shadow-lg transition hover:bg-red-50 hover:scale-105 cursor-pointer"
                  >
                    <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
