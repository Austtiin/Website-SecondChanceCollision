        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-white to-neutral-50 p-8 shadow-lg ring-1 ring-black/5">
          ...
          <div className="relative space-y-6">
            ...
            <div className="space-y-4">
              {/* Phone */}
              <a href="tel:612-913-6594" className="group flex items-start gap-4 rounded-xl p-4 transition hover:bg-neutral-50">
              ...
              {/* Email */}
              <a href="mailto:shop@secondchance-collision.com" onClick={handleEmailClick} className="group flex items-start gap-4 rounded-xl p-4 transition hover:bg-neutral-50">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm font-bold text-[var(--accent-dark)] group-hover:text-[var(--accent-red)] break-all">shop@secondchance-collision.com</p>
